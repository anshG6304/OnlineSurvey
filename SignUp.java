	...
	public void signUpView() {
		...
		submit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				char[] pass1 = uPassField.getPassword();
				char[] pass2 = uPassField2.getPassword();
				String p1 = Arrays.toString(pass1);
				String p2 = Arrays.toString(pass2);
				if(fname.isEmpty() || uname.isEmpty() || p1.isEmpty() || p2.isEmpty()) {
